...
const CX = () => {
  ...
  const [capabilityEffortsValue, setCapabilityEffortsValue] = useState('');
  const [capabilityLeadership, setCapabilityLeadership] = useState('');
  const [capabilityLeadershipValue, setCapabilityLeadershipValue] = useState('');
  const [capabilityResources, setCapabilityResources] = useState('');
  const [capabilityResourcesValue, setCapabilityResourcesValue] = useState('');
  const [cxObjectives, setCxObjectives] = useState('');
  const [cxObjectivesValue, setCxObjectivesValue] = useState('');
  const [metricsMeasures, setMetricsMeasures] = useState('');
  const [metricsMeasuresValue, setMetricsMeasuresValue] = useState('');
  ...
  const [symptomsAssociatesValue, setSymptomsAssociatesValue] = useState('');
  const [symptomsAwareness, setSymptomsAwareness] = useState('');
  const [symptomsAwarenessValue, setSymptomsAwarenessValue] = useState('');
  const [symptomsBrand, setSymptomsBrand] = useState('');
  const [symptomsBrandValue, setSymptomsBrandValue] = useState('');
  const [symptomsBudget, setSymptomsBudget] = useState('');
  const [symptomsBudgetValue, setSymptomsBudgetValue] = useState('');
  const [symptomsCustomer, setSymptomsCustomer] = useState('');
  const [symptomsCustomerValue, setSymptomsCustomerValue] = useState('');
  const [symptomsExecutive, setSymptomsExecutive] = useState('');
  const [symptomsExecutiveValue, setSymptomsExecutiveValue] = useState('');
  const [symptomsImprovement, setSymptomsImprovement] = useState('');
  const [symptomsImprovementValue, setSymptomsImprovementValue] = useState('');
  const [symptomsInnovation, setSymptomsInnovation] = useState('');
  const [symptomsInnovationValue, setSymptomsInnovationValue] = useState('');
  const [symptomsInsights, setSymptomsInsights] = useState('');
  const [symptomsInsightsValue, setSymptomsInsightsValue] = useState('');
  const [symptomsListening, setSymptomsListening] = useState('');
  const [symptomsStrategy, setSymptomsStrategy] = useState('');
  const [symptomsStrategyValue, setSymptomsStrategyValue] = useState('');
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setCapabilityEffortsValue('');
      setCapabilityLeadership('');
      setCapabilityLeadershipValue('');
      setCapabilityResources('');
      setCapabilityResourcesValue('');
      setCxObjectives('');
      setCxObjectivesValue('');
      setMetricsMeasures('');
      setMetricsMeasuresValue('');
      setOpportunityOne('');
      setOpportunityTwo('');
      setOpportunityThree('');
      setStrengthOne('');
      ...
      setSymptomsAssociatesValue('');
      setSymptomsAwareness('');
      setSymptomsAwarenessValue('');
      setSymptomsBrand('');
      setSymptomsBrandValue('');
      setSymptomsBudget('');
      setSymptomsBudgetValue('');
      setSymptomsCustomer('');
      setSymptomsCustomerValue('');
      setSymptomsExecutive('');
      setSymptomsExecutiveValue('');
      setSymptomsImprovement('');
      setSymptomsImprovementValue('');
      setSymptomsInnovation('');
      setSymptomsInnovationValue('');
      setSymptomsInsights('');
      setSymptomsInsightsValue('');
      setSymptomsListening('');
      setSymptomsStrategy('');
      setSymptomsStrategyValue('');
      setThreatOne('');
      setThreatTwo('');
      setThreatThree('');
      setWeaknessOne('');
